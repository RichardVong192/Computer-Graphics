...
void myTimer(int value)
{
    ...
    glutPostRedisplay();
    glutTimerFunc(25, myTimer, 0);   //(time, what to call, counter value)
}
...
void drawModel()
{
    ...
    glPushMatrix();
      ...
      glRotatef(-theta, 1, 0, 0);     // Rotation by theta about the pivot point
      glTranslatef(0.8, -4, 0);    //
    ...
    glPushMatrix();
      glTranslatef(0.8, 4, 0);      //
      glRotatef(theta, 1, 0, 0);     // Rotation by theta about the pivot point (0.8, 4, 0)
      glTranslatef(-0.8, -4, 0);    //
      glTranslatef(0.8, 2.2, 0);
      glScalef(1, 4.4, 1);
      glutSolidCube(1);
