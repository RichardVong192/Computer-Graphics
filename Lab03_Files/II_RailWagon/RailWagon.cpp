...
void loadTexture()
{
    ...
    //Replace = replaces colour with texture color
    //Modulate = mix the normal colour with texture color (normal colour is effected by lighting
}
...
void wagon()
{
    ...
    glBegin(GL_QUADS);
      ...
      glTexCoord2f(1, 0.33984375);  glVertex3f(35.0, 17.0, 6.0);
      glTexCoord2f(0, 0.33984375);  glVertex3f(-35.0, 17.0, 6.0);
      ...
      glTexCoord2f(1., 0.);
      glVertex3f(-35.0, 5.0,-6.0);
      glTexCoord2f(1, 0.33984375);
      glVertex3f(-35.0, 17.0,-6.0);
      glTexCoord2f(0, 0.33984375);
      glVertex3f(35.0, 17.0, -6.0);

      glNormal3f(0.0, 1.0, 0.0);   //Facing +y (Top side)
      glTexCoord2f(0., 0.44921875);
      glVertex3f(-35.0, 17.0, 6.0);
      glTexCoord2f(1, 0.44921875);
      glVertex3f(35.0, 17.0,  6.0);
      glTexCoord2f(1, 0.828125);
      glVertex3f(35.0, 17.0, -6.0);
      glTexCoord2f(0., 0.828125);
      glVertex3f(-35.0, 17.0, -6.0);
    glEnd();
